...
- [ ] Thẻ tổng quan "Tổng công nợ phải thu" hiển thị số tiền lớn, rõ ràng
- [ ] Bảng danh sách Khách hàng (Tên, SĐT, Địa chỉ, Lịch sử mua hàng, Tổng tiền đã mua, Dư nợ)
- [ ] Tìm kiếm Khách hàng theo Tên hoặc Số điện thoại
- [ ] Drawer/Modal Chi tiết Khách hàng hiển thị lịch sử đơn hàng phát sinh nợ và các lần thu nợ trước
- [ ] Nút "Thanh toán nợ": popup nhập số tiền trả, phương thức (Tiền mặt / Chuyển khoản) và ghi chú
- [ ] Tự động trừ lùi Dư nợ lũy kế theo nguyên tắc Sổ nợ lũy kế (ADR-0002)
- [ ] Tạo bản ghi Phiếu thu nợ (Debt Payment) và lưu vết ngày giờ trả nợ
